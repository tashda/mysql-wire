...
public extension MySQLAdminClient {
    func logDestinations() async throws -> [MySQLLogDestination] {
        let variables = try await globalVariables()
    ...
    func readTableLog(named tableName: String, limit: Int = 100) async throws -> [[String: String?]] {
